...
const CreatePost = ({ open, setOpen }) => {
    ...
    const createPostHandler = async (e) => {
        ...
        try {
            setLoading(true);
            const res = await axios.post('https://socialmediaapp-waa8.onrender.com/api/v2/post/addpost', formData, {
                headers: {
    ...
    return (
        <>
            <Dialog open={open}>
                <DialogContent onInteractOutside={() => setOpen(false)} className="outline-none">
